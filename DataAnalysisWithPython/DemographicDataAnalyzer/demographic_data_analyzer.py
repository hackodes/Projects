...
def calculate_demographic_data(print_data=True):
    ...
    rich_country_proportion = (rich_country_counts / country_counts)

    highest_earning_country = rich_country_proportion.idxmax()
    highest_earning_country_percentage = round(rich_country_proportion.max() * 100, 1)

    # Identify the most popular occupation for those who earn >50K in India.
    people_in_india = df[df['native-country'] == 'India']
    occupation_count = people_in_india[people_in_india['salary'] == '>50K']['occupation'].value_counts()
